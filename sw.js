...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-ad8be6","is-html-ad8be6","is-jsdelivr-ad8be6","is-gtm-ad8be6","is-gravatar-ad8be6","is-theme-ad8be6","is-cdn-ad8be6","is-json-ad8be6"];
      return Promise.all(
        names
